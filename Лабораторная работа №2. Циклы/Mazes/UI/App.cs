...
public partial class App
{
    ...
    private static IEnumerable<TestCase> CreateTestCases()
    {
        ...
        yield return new MazeTestCase("empty6_MyFile", EmptyMazeTask.MoveOut);
        yield return new MazeTestCase("empty7_MyFile", EmptyMazeTask.MoveOut);
        ...
        yield return new MazeTestCase("snake4_MyFile", SnakeMazeTask.MoveOut);
        yield return new MazeTestCase("snake5_MyFile", SnakeMazeTask.MoveOut);
        ...
        yield return new MazeTestCase("pyramid5_MyFile", PyramidMazeTask.MoveOut);
        yield return new MazeTestCase("pyramid6_MyFile", PyramidMazeTask.MoveOut);
        ...
        yield return new MazeTestCase("diagonal4_MyFile", DiagonalMazeTask.MoveOut);
        yield return new MazeTestCase("diagonal5_MyFile", DiagonalMazeTask.MoveOut);
    }
}